defmodule Hierarchy.LTree do
  @moduledoc """
  LTree module for working with ltree paths
  """

  @separator "."

  @doc """
  Returns the parent_id of the given ltree path
  ...
  @doc """
  Returns the root_id of the given ltree path
  ...
  @doc """
  Splits string path into an arry
  """
  def split(nil), do: []
  def split(""), do: []
